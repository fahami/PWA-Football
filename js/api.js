                  ...
                  teams.forEach((tim) => {
                    if ((match.homeTeam.id == tim.id) && (tim.crestUrl != null)) {
                      champLeagueHTML += `
                        ...
                        <div class="row">
                          <div class="col s4 m5">
                            <img class="materialboxed club-logo" src="https://crests.football-data.org/${match.homeTeam.id}.svg" loading="lazy" alt="${match.homeTeam.name} Logo">
                          ...
                          <div class="col s4 m5">
                            <img class="materialboxed club-logo" src="https://crests.football-data.org/${match.awayTeam.id}.svg" loading="lazy" alt="${match.awayTeam.name} Logo">
                ...
                teamHTML = `
                  <div class="card">
                      <div class="card-image waves-effect waves-block waves-light">
                        <img src="${data.crestUrl}" class="club-logo" loading="lazy" alt="${data.name} Logo"/>
                      </div>
